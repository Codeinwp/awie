...
class Awye_Recent_A extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'recent_posts_a clearfix', 'description' => __( 'Recent posts widget Type A (front page)', 'awie') );
		parent::__construct('recent_posts_a', __('Flymag: Recent posts type A', 'awie'), $widget_ops);
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'awie' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Enter the slug for your category or leave empty to show posts from all categories.', 'awie' ); ?></label>
